...
public class aaaa {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		try {
			...
			try {
				// Perform a tap somewhere else (e.g., top of the screen) before entering the
				// amount
				TouchAction touchAction = new TouchAction((AndroidDriver) driver);
				// Tap at a specific location (coordinates might need adjustment depending on
				// your layout)
				touchAction.tap(PointOption.point(100, 100)).perform();

				/*
				 * System.out.println("Waiting for the number input field..."); WebElement
				 * amountInputFld =
